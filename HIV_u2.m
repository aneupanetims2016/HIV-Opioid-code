...
legend('with u_2=0 ','with u_2=1','Location','northwest') 
...
legend('with u_2=0 ','with u_2=1') 
 title('Number of HIV Positive when u_2 only is present','fontweight','normal','fontsize',18)
...
legend('with control u_2','with out control u_2','location','northwest') 
 title('Number of opioid addicted Individuals','fontweight','normal','fontsize',18)
 ylabel('U(t)','fontweight','normal','fontsize',18)
 xlabel('Years','fontweight','normal','fontsize',18)
 xticks([1 6 11 16 21 26 31 36 40 ])
  yticks([200000 400000 600000 800000 1000000 1200000 1400000 1600000 ])
   yticklabels({'2x10^5', '4x10^5', '6x10^5', '8x10^5','10x10^5','12x10^5', '14x10^5', '16x10^5'})
 set(gca, 'YGrid', 'on', 'XGrid', 'off','LineWidth', 2,'fontsize',14)
hold off
...
legend('with control u_2','with out control u_2') 
...
figure
plot(tforward,u,'r-.','LineWidth',2.5)
title('Treatment for addicted individuals only (u_2)','fontweight','normal','fontsize',18)
...
dy(2) = (beta_u*(U+I_1+I_2)*S./N)-(q_u*(1-u2t)*beta_v*(V+I_1+I_2)*U./N)- (mu+mu_u + delta)*U;
...
u2timedep = utimedep(:,1);
   ...
   dlambda(2) = -0.1 + (lambda(1)-lambda(2))*beta_u*St*(St+Vt+At)./Nt^2+...
